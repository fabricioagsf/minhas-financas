...
import com.fagsf.minhasfinancas.model.enums.StatusLancamento;
import com.fagsf.minhasfinancas.model.enums.TipoLancamento;
...
public class LancamentoModelo {
	...
	//força uso de funcionalidade nao suportada pelo hibernate
	@Convert(converter = Jsr310JpaConverters.LocalDateConverter.class)
	private LocalDate dataCadastro;
	
	@Column(name = "tipo")
	//define se sera gravado no banco por ordem ex 1,2,3 ou de forma literal
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LancamentoModelo other = (LancamentoModelo) obj;
